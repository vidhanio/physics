...
import BlogArticleLayout from "layouts/article";
    ...
    <>
      ...
      <header className="flex flex-col items-center justify-center gap-4 text-center">
        ...
        <div className="flex flex-col">
          ...
          >
            <a
              href={`https://github.com/vidhanio/physics/commit/${post.hashAdded}`}
            >
          ...
          {dateUpdated && (
            ...
            >
              <a
                href={`https://github.com/vidhanio/physics/commit/${post.hashUpdated}`}
              >
                Edited:{" "}
